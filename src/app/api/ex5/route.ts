...
const TEMPLATE_RESUME = `Based on the resume answer the user's questions. If the resume does not contain the information required to answer, reply respectfully that the information is not available. Here's what we know:
  ==============================
  Resume Details:
  {context}
  ==============================
